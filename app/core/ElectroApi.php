...
abstract class ElectroApi {
    ...
    public function killFailureWithMsg(string $exception) {
        $this->killAsFailure([$exception => true]);
    }

    public function killCompromisedWithMsg(string $exception) {
        $this->killAsCompromised([$exception => true]);
    }
    ...
    private function onKillContractSigned(int $contract_code) {}
