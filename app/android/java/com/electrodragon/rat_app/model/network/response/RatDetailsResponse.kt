...
data class RatDetailsData (
        @SerializedName(ApiResponseConstant.EXCEPTIONS) val exceptions: RatDetailsResponseClasses.Exceptions?,
        @SerializedName("attribute_name") val attributeName: Boolean?
)

object RatDetailsResponseClasses {
